                    ...
                    <div v-for="(item, index) in listaHoja" class="col-md-4 col-6 col-lg-3">
                        <div class="product">
                            <div class="product_img">
                                <a :href="'shop-product-detail-remate.php?prod='+item.prod_id">
                            ...
                            <div class="product_info">
                                <h6 class="product_title titulo_prod" ><a  :href="'shop-product-detail-remate.php?prod='+item.prod_id">{{item.nombre}}</a></h6>
