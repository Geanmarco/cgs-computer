...
" href="shop-product-detail.php?prod=<?= $rowPrC['prod_id'] ?>"><?= $rowPrC['nombre'] ?></a></li>
                        ...
                        <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                ?>
                                        ...
                                        <div class="carousel-item <?= ($countBan == 1)  ? 'active' : '' ?>   background_bg" style="cursor: pointer;" onclick="location.href='<?= $rowBan['url']  ?>';" data-img-src="../public/img/bannerb/<?= $rowBan['imagen']  ?> " style="">
    ...
    <div class="main_content">
                                    ...
                                    <div class="tab-pane fade show active" id="arrival" role="tabpanel" aria-labelledby="arrival-tab">
                                        <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
                                           ...
                                           // echo "<br>";
                                            ...
                                            ?>
                                                <?php
                                                //var_dump($proN['stock'] !== '0.000' );
                                                //var_dump($proN['stock_prod'] !== '0');
                                                //var_dump($proN['estado'] == '1');
                                                if ( true) : ?>
                                                    <div class="item">
                                                        <div class="product_wrap">
                                                            ...
                                                            <div class="product_img">
                                                                ...
                                                                ?>
                                                                <a href="<?= $url_detalle ?>">
                                                                    <img style="max-width: 540px; max-height: 600px;" src="../public/img/productosb/<?= $proN['imagen1'] ?>" alt="el_img3">
                                                                    <img style="max-width: 540px; max-height: 600px;" class="product_hover_img" src="../public/img/productosb/<?= $proN['imagen2'] ?>" alt="el_hover_img3">
                                                        ...
                                                        <img style="max-width: 540px; max-height: 600px;" class="product_hover_img" src="../public/images/Exclusivos/c_i72.jpg" alt="el_hover_img3"-->
                                                            ...
                                                            <div class="product_info">
                                                                <h6 class="product_title" <?= $body_class == 'desktop' ? ' style="height: 40px;" ' : ' ' ?>>
                                                                    <a style="white-space: normal" href="<?= $url_detalle ?>"><?= $proN['nombre'] ?></a></h6>
                                                        ...
                                                        <div class="product_wrap">
                                                            <div class="product_img">
                                                                <a href="shop-product-detail.php?prod=<?= $itemMV['prod_id'] ?>">
                                                                    <img src="../public/img/productosb/<?= $itemMV['imagen1'] ?>" alt="el_img7">
                                                                    <img class="product_hover_img" src="../public/img/productosb/<?= $itemMV['imagen2'] ?>" alt="el_hover_img7">
                                                                </a>
                                                                <div class="product_action_box">
                                                                    <ul class="list_none pr_action_btn">
                                        ...
                                        <div class="deal_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.php?prod=<?= $ofeItem['prod_id'] ?>">
                                                    <img src="../public/img/productosb/<?php echo $ofeItem['imagen1'] ?>" alt="el_img1">
                                                </a>
                                            </div>
        ...
        <!-- END SECTION SHOP -->
        <div class="section bg_default" style="padding-bottom: 15px;padding-top: 15px;">
            <div class="custom-container">
                <div class="row align-items-center">
                    <div class="col-md-6" style=" margin: auto;">
                        <div class="text_white">
                            <span style="font-size: 63px;font-weight: bold;">ZONA DE</span>
                            <img style=" max-width: 212px;" src="../public/Screenshot_12.png">
                            <span style="font-size: 63px;font-weight: bold;">REMATE</span>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 d-none d-xl-block">
                        ...
                        <div class="sale-banner">
                            <a class="hover_effect1" href="<?= $banner55FinalExtra['url'] ?>">
                                <img src="../public/img/bannerb/<?= $banner55FinalExtra['imagen'] ?>" alt="shop_banner_img10">
                            </a>
                        </div>
                    ...
                    <div class="col-xl-3 d-none d-xl-block">
                        ...
                        <div class="sale-banner">
                            <a class="hover_effect1" href="<?= $banner6FinalExtra['url'] ?>">
                                <img src="../public/img/bannerb/<?= $banner6FinalExtra['imagen'] ?>" alt="shop_banner_img10">
                            </a>
                        </div>
                                ...
                                if ($contadorBC < 3) {
                                    ...
                                    if (!is_null($rowProBC['precio_ofertaa'])) {
                                        ...
                                        <a href="shop-product-detail.php?prod=' . $rowProBC['prod_id'] . '">
                                            <img src="../public/img/productosb/' . $rowProBC['imagen1'] . '" alt="el_img7">
                                            <img class="product_hover_img" src="../public/img/productosb/' . $rowProBC['imagen2'] . '" alt="el_hover_img7">
                                        </a>
                                    </div>
                                        ...
                                        <div class="item">';
                                                ...
                                                <div class="product_img">
                                                    <a href="shop-product-detail.php?prod=' . $ofeItem['prod_id'] . '">
                                                        ...
                                                        <img  style="" src="../public/img/productosb/' . $ofeItem['imagen1'] . '" alt="el_img3">
                                                        <img  class="product_hover_img" src="../public/img/productosb/' . $ofeItem['imagen2'] . '" alt="el_hover_img3">
                                                    </a>
                                                </div>
                                                <div class="product_info">
                                                    <h6 class="product_title titulo_prod"><a href="shop-product-detail.php?prod=' . $ofeItem['prod_id'] . '">' . $ofeItem['nombre'] . '</a></h6>
...
<li><a href="../public/librorec/libro.php" target="_blank"><img src="../public/librorec/libro.png" width="60%"  alt="libro reclamaciones"></a>
</li>
                        ...
                        <div class="widget">
                            ...
                            <ul class="widget_instafeed instafeed_col4">
                                <?php foreach ($listaRamTendenInstagram as $val) :
                                    /*    var_dump($val); */
                                ?>
                                    <li><a href="shop-product-detail.php?prod=<?= $val['prod_id'] ?>"><img src="../public/img/productosb/<?php echo $val['imagen1'] ?>" alt="insta_img"><span class="insta_icon"></span></a></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                    </div>
