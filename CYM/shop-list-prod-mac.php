...
$nom_marc='';
$sql="SELECT nombre_marca FROM marcra_productos WHERE cod_marca ='$marcaTEEEEE'";
if ($row_marc = $conexion->query($sql)->fetch_assoc()){
    $nom_marc=$row_marc['nombre_marca'];
}
