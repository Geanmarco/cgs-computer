...
<!-- SITE TITLE -->
<title><?=$caterogoria_nom?> | CGS-COMPUTER</title>
<!-- Favicon Icon -->
                                ...
                                <div style="padding: 11px;">
                                    ...
                                    <div class="widget">
                                        ...
                                        <div class="filter_price">
                                            <span onclick="APP_PROD.getFiltrar()" class="on-click-cont" style="/* left: 115%; */padding-left: 8px;padding-top: 3px;/* top: -15px; */width: 30px;border-radius: 5px;height: 30px;float: right;background-color: #4746EB !important;/* margin-bottom: 200px; */color: white;bottom: 15px;position: relative;"><i class="fa fa-search"></i></span>
