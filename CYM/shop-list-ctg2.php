...
$listaGrupos=[
    ["nombre" => 'PROCESADOR', "codi_categoria" => "001"],
    ["nombre" => 'PLACA MADRE', "codi_categoria" => "040"],
    ["nombre" => 'MEMORIA RAM', "codi_categoria" => "012-014"],
    ["nombre" => 'DISCO/ALMACENAMIENTO', "codi_categoria" => "002"],
    ["nombre" => 'FUENTE', "codi_categoria" => "010"],
    ["nombre" => 'CASE', "codi_categoria" => "030"],
    ["nombre" => 'TARJETA DE VIDEO', "codi_categoria" => "050"],
    ["nombre" => 'MONITOR', "codi_categoria" => "060"],
    ["nombre" => 'TECLADO', "codi_categoria" => "070"],
    ["nombre" => 'COOLER/ REFRIGERACION LIQUIDA', "codi_categoria" => "080"],
    ["nombre" => 'PARLANTE', "codi_categoria" => "090"],
    ["nombre" => 'MOUSE', "codi_categoria" => "100"],
    ["nombre" => 'ESTABILIZADOR', "codi_categoria" => "110"],
];
?><!DOCTYPE html>
                                ...
                                <div class="rating_wrap">
                                    ...
                                    <span class="rating_num">
                                        <strong>Stock: <a href="javascript:void(0)">
                                                <span v-if="formartNumberStock(item.stock)==0" style="color: #d70000;font-weight: lighter;"> Sin Stock</span>
...
<script src="../public/js/main.js?v=2?vr=2"></script>
