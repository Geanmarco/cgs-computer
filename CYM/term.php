        ...
        <div class="row align-items-center">
        	<div class="col-md-6">
                <div class="page-title">
            		<h1 style="text-transform: none;">Términos y Condiciones</h1>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="term_conditions">
                            ...
                            <div style="border-style: solid; border-color:#ef00ff; border-radius: 25px; margin-bottom: 25px;">
                                <div style="margin: 25px;">
                                    <div>

                                <h2 style="text-align: center; font-weight: bold; text-decoration: underline;"></h2>
                                <p></p>
