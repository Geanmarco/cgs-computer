...
<div class="preloader">
    ...
    <!-- START HEADER -->
    <div class="custom-container" style="padding: 11px; width: 100%;overflow: hidden; background-color: #232323;">
        <i class="ti-location-pin" style="float: left; color: #fff;"></i>
        <p style="float: left; margin: 0px; color: #fff;"><strong><?= $dataConf['direccion'] ?></strong></p>
    </div> 
    <header class="header_wrap">
        <?php include "../fragment/nav_bar_index.php" ?>
        <div style="background-color: #232323; height: 68px;margin-top:-2px;" class="bottom_header dark_skin main_menu_uppercase border-top border-bottom">
...
" href="shop-product-detail.php?prod=<?= $rowPrC['prod_id'] ?>"><?= $rowPrC['nombre'] ?></a></li>
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse mobile_side_menu" id="navbarSidetoggle">
                                <ul class="navbar-nav" <?= $body_class == 'desktop' ? ' style="backgroud:black;" ' : ' ' ?>>
                                    ...
                                    <li class="dropdown panel-palpitante nav-options-i">
                                    ...
                                    <li class="nav-options-i">
                                        <a class="nav-link menu-var" href="shop-list-prod.php?search=+&type=last">PROFORMA</a>

                                    </li>

                                    <li class="dropdown panel-palpitante nav-options-i">
                                        <a class="nav-link texto-palpitante" href="shop-list-prod-remate.php">COMPUTADORAS</a>

                                    </li>
                                    <li class="nav-options-i">
                                        <a class="nav-link menu-var " href="./shop-list-prod-exclu.php">REMATES</a>
                                    </li>
                                    <li class=" panel-palpitante nav-options-i">
                                        <a class="nav-link  texto-palpitante " href="shop-list-prod-remates.php">TALLERES</a>
    ...
    <div class="main_content">
                                        ...
                                        <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
                                            ...
                                            foreach ($listaNue as $proN) {
                                                ...
                                                if (!is_null($proN['precio_ofertaa'])) {
                                                    ...
                                                    $ahorroSol = $tc * $ahorro;
                                                    $precioProdSol =  number_format($tc * floatval(), 2, '.', ',');
                                                        ...
                                                        <img style="max-width: 540px; max-height: 600px;" class="product_hover_img" src="../public/images/Exclusivos/c_i72.jpg" alt="el_hover_img3"-->
                                                                ...
                                                                <div class="product_action_box">
                                                                    <ul class="list_none pr_action_btn">
                                                                        <li <?= $proN['tipo_pro'] == 2 ? 'hidden' : '' ?> class="add-to-cart"><a onclick="CARRITO.espe_prod_carr(<?= $proN['prod_id'] ?>)" href="javascript:void(0)"><i class="icon-basket-loaded"></i> Añadir al carrito</a></li>
                                                                        <li><a href="shop-compare.php?prod=<?= $proN['prod_id'] ?>" class="popup-ajax"><i class="icon-shuffle"></i></a></li>
                                                                        <li><a href="shop-quick-view.php?prod=<?= $proN['prod_id'] ?>&stok=<?= $proN['stock_prod'] + $proN['stock'] ?>" class="popup-ajax"><i class="icon-magnifier-add"></i></a></li>
                                                            ...
                                                            <div class="product_info">
                                                                <h6 class="product_title" <?= $body_class == 'desktop' ? ' style="height: 40px;" ' : ' ' ?>>
                                                                    <a style="white-space: normal" href="<?= $url_detalle ?>"><?= $proN['nombre'] ?></a>
                                                                </h6>
                                                            ...
                                                            <div class="product_img">
                                                                ...
                                                                <div class="product_action_box">
                                                                    <ul class="list_none pr_action_btn">
                                                                        ...
                                                                        <li><a href="shop-quick-view.php?prod=<?= $itemMV['prod_id'] ?>&stok=<?= $itemMV['stock']  ?>" class="popup-ajax"><i class="icon-magnifier-add"></i></a></li>
                                                                        <li><a href="javascript:void(0)"><i class="icon-heart"></i></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="special" role="tabpanel" aria-labelledby="special-tab">
                                        <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
                                            ...
                                            foreach ($listaOfertas as $proN) {
                                                ...
                                                $ahorroSol = $tc * $ahorro;
                                                $precioProdSol =  number_format($tc * floatval($precioProd), 2, '.', ',');
                                                $ahorroSol = number_format($tc * $ahorro, 2, '.', ',');
                                                $ahorroSol = number_format(floatval(0), 2);
                                                /* var_dump($ahorro); */
                                                        ...
                                                        <img style="max-width: 540px; max-height: 600px;" class="product_hover_img" src="../public/images/Exclusivos/c_i72.jpg" alt="el_hover_img3"-->
                                                                ...
                                                                <div class="product_action_box">
                                                                    <ul class="list_none pr_action_btn">
                                                                        ...
                                                                        <li><a href="shop-compare.php?prod=<?= $proN['prod_id'] ?>" class="popup-ajax"><i class="icon-shuffle"></i></a></li>
                                                                        <li><a href="shop-quick-view.php?prod=<?= $proN['prod_id'] ?>&stok=<?= $proN['stock'] ?>" class="popup-ajax"><i class="icon-magnifier-add"></i></a></li>
                                                                        <li><a href="javascript:void(0)"><i class="icon-heart"></i></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
        ...
        <!-- END SECTION SHOP -->
        <div class="section bg_default" style="background-color:#4746EB  !important;padding-bottom: 15px;padding-top: 15px;">
            <div class="custom-container">
                <div class="row align-items-center">
                    <div class="col-md-6" style=" margin: auto;">
                        <div class="text_white">
                            <span style="font-size: 43px;font-weight: bold;">SOMOS CGS</span>
			    <img style=" max-width: 100px;" src="../public/Screenshot_13.jpg">
                            <span style="font-size: 43px;font-weight: bold;">TU MEJOR OPCI&Oacute;N</span>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 d-none d-xl-block">
                        ...
                        <div class="sale-banner">
                            <a class="hover_effect1" href="<?= $banner55FinalExtra['url'] ?>">
                                <img src="../public/img/banner/<?= $banner55FinalExtra['imagen'] ?>" alt="shop_banner_img10">
                            </a>
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="newsletter_text text_white">
                            <h3>El lugar preferido de streamers y gamers CGS</h3>
                            <p>Recibe las mejores Ofertas en Gaming y Streaming SUSCR&Iacute;BETE</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="newsletter_form2 rounded_input">
                            <form id="formPromociones">
                                ...
                                <button type="button" class="btn btn-dark btn-radius" id="btnRegistrar">Suscr&iacute;bete</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <footer class="bg_gray">
                            ...
                            <ul class="widget_links">
                                ...
                                <li>
                                    <a href="../public/librorec/libro.php" target="_blank">
                                        <img src="../public/librorec/libro2.png" alt="libro reclamaciones"></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="icon_box icon_box_style2">
                                        ...
                                        <div class="icon_box_content">
                                            ...
                                            <p>Consultar al Whatsapp 922 211 531</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
        ...
        <div class="bottom_footer border-top-tran">
            <div class="custom-container">
                <div class="row">
                    <div class="col-lg-4">
                        <p class="mb-lg-0 text-center">&copy; <?= date('Y') ?> Todos los derechos reservados por <a target="_blank" href="https://wa.me/51989722337"><strong>JORGE DEVELOPER</strong></a> </p>
                    </div>
    ...
    <div style="display: none" class="contenedor_wapsa apertura_what">
        <div style="width: 100%;text-align: center">
            <h4 style="color: #009237">Nuestros Asesores CGS</h4>
        </div>
        <div class="contenedor_inferior">
            <?php
    ...
    <script>
        ...
        //     // Configurar el evento de clic para mostrar/ocultar el menú
