        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <ul class="navbar-nav attr-nav align-items-center">
                ...
                <li  class="dropdown cart_dropdown" id="content-carrito">
                    <a id="car-elemnt" class="nav-link cart_trigger" href="#" data-toggle="dropdown"><i class="linearicons-cart"></i><span v-if="listaCarrito.length>0" class="cart_count">{{listaCarrito.length}}</span></a>
